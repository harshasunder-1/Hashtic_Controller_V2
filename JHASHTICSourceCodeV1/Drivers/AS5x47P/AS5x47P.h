...
#define ERRFL_READ_FRAME 0x4001


#define AS5047_FRAME_ERROR 1
#define AS5047_INVALID_COMMAND_ERROR 2
#define AS5047_PARITY_ERROR 3
#define AS5047_NO_ERROR 4
...
uint16_t getEncoderElectricalAngleFromSPI(uint8_t continuousRead);
